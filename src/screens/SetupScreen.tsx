...
const styles = StyleSheet.create({
  ...
  generalThemeInput: { fontFamily: 'Inter_500Medium', fontSize: 14, color: theme.colors.textSecondary, letterSpacing: 4, textTransform: 'uppercase', marginBottom: 32, textAlign: 'center', minWidth: 200 },
  ...
  summaryDeleteBtnText: { fontFamily: 'Inter_500Medium', fontSize: 16, color: theme.colors.textSecondary, opacity: 0.6 },
  ...
  // Full edit styles
  fullEditHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 60, paddingBottom: 20, paddingHorizontal: 24, borderBottomWidth: 1, borderBottomColor: theme.colors.border, backgroundColor: theme.colors.surface },
  backBtn: { width: 80 },
  ...
  label: { fontFamily: 'Inter_500Medium', fontSize: 12, color: theme.colors.textSecondary, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
  ...
  fullEditTextArea: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 22, color: theme.colors.textPrimary, borderWidth: 1, borderColor: theme.colors.border, borderRadius: theme.geometry.radius, padding: 20, minHeight: 200, textAlignVertical: 'top', backgroundColor: theme.colors.surface },
  ...
  fullEditFooter: { position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', padding: 24, paddingBottom: 40, backgroundColor: theme.colors.background, borderTopWidth: 1, borderTopColor: theme.colors.border, gap: 16 },
  deleteBtnLarge: { flex: 1, paddingVertical: 18, alignItems: 'center', borderRadius: theme.geometry.radius, borderWidth: 1, borderColor: theme.colors.error },
  deleteBtnLargeText: { fontFamily: 'Inter_500Medium', fontSize: 16, color: theme.colors.error },
  ...
  saveBtnLargeText: { fontFamily: 'Inter_500Medium', fontSize: 16, color: theme.colors.background, letterSpacing: 1 },
});
